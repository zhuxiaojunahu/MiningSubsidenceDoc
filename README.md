...
![地表任意点任意方向的预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image018.png) <br>
*图4-1 地表任意点任意方向的预计*
...
![反演的步骤](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image044.jpg) <br>
*图5-1 开采沉陷预计功能模块*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image045.png) <br>
*图5-2 预计参数文件*

其格式为： <br>
第一行为各个参数的名称（见图5-3）： <br>
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image047.jpg) <br>
*图5-3 开采沉陷预计参数表头*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image049.jpg) <br>
图5-4 开采沉陷预计的拐点偏移距

余下的数据为每个工作面的角点，由每个角点的X、Y（大地坐标）、H组成，依次按这种格式写入，点数不限，建议不超过8个角点。 <br>
注：写入点时按逆时针顺序依次写入。

![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image051.jpg) <br>
*图5-5 预计工作面角点数据*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image053.png)  <br>
*图5-6 预计数据文件导入* <br>

导入后，系统将在左侧栏显示导入工作面的名称以及系统右侧显示所有工作面的参数，以便检查（图5-7）。 <br>
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image055.jpg)  <br>
*图5-7 导入数据的检查*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image057.jpg)  <br>
图5-8 工作面角点平面坐标的获取 <br>
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image061.jpg)  <br>
*图5-9 图形绘制界面*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image063.jpg)   <br>
*图5-10 开采沉陷预计选项窗口*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image065.jpg)    <br> 
*图5-11工作面剖分设置*

![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image067.jpg)  <br>
*图5-12人工设定工作面剖分大小*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image069.jpg)   <br>
*图5-13预计文件输出路径*

**（4）剖分显示模式** <br>
剖分显示模式，如图5-14所示，用户可以在此处设置剖分模式的显示模式，根据用户的选择，可以在示意图一栏中看到用户设置的剖分模式下所剖分的工作面细节情况，本项操作需输入密码，具体请咨询软件所有者。 <br>
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image071.jpg)   <br>
*图5-14分显示模式*
...
![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image077.jpg)   <br>
*图5-16 预计结果查看窗口*
...
>（1）点击【数据输出】中【预计点输出】，可以EXCEL方式输出预计点的结果。表格输出的结果有：点序号、点X坐标、点Y坐标、下沉、倾斜、曲率、水平移动、水平变形、预计方向+90度的倾斜、曲率、水平移动、水平变形。<br>
 ![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image079.jpg)  <br>
图5-17 开采沉陷预计结果输出表

>（2）在软件安装路径\DataResults文件夹下存放所有预计结果的数据文件。

 ![预计参数文件](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image081.jpg)   <br>
图5-18 自动存放的预计结果数据文件

预计结果数据文件包括：下沉值预计结果文件w.dat；指定预计方向倾斜变形值预计结果文件i.dat；指定预计方向曲率变形值预计结果文件k.dat；指定预计方向水平移动值预计结果文件u.dat；指定预计方向水平变形值预计结果文件e.dat；指定预计方向+90度倾斜变形值预计结果文件it.dat；指定预计方向+90度曲率变形值预计结果文件看kt.dat；指定预计方向+90度水平移动值预计结果文件ut.dat；指定预计方向+90度水平变形值预计结果文件et.dat。 <br>
各预计结果文件的数据格式为： <br>
点名，X坐标（大地坐标），Y，预计值
...
> （6）如图5-20下部所示，“等级划分”，用户根据现场资料以及相关的章程设置不同的临界值，以便于绘制出相应的损害等级图，具体操作方法为：1、“等值线基本设置”中设置各损害等级曲线的颜色；2、在“下沉w设置”中勾选 “绘制等级图”，并根据具体情况设置各等级数值；3、点击【文件】中相对应的【打开下沉w文件】，此时绘图界面会出现相应的损害等级图
 ...
 ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image085.jpg)  <br>
*图5-19 基本等值线设置*

 ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image087.jpg)   <br>
*图5-20等值线选项*

 ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image089.jpg)  <br>  
*图5-21 开采沉陷预计等值线绘制与编辑处理*
 
 ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image091.jpg)  <br> 
*（1）三维立体图形*

 ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image093.jpg)   <br>
*（2）彩色等值线图像*
...
准备数据文件如下：<br>
  ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image107.jpg)    <br>
*图 5-16 预计准备数据文件*
...
（4）	在安装路径\TEMP文件下查看预计的结果，同时画出等值线。
  ...
  ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image109.png)   <br> 
*图 5-17 预计范围下沉等值线*

如果需要预计指定的点，则在步骤（2）时修改安装路径\Date\AutoPoint.txt，按照格式修改即可。如预计（100,0）处，预计方向为135°的点地表移动变形情况，则修改AutoPoint.txt如图

  ![预计](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image111.jpg)  <br>
...
开采沉陷概率积分法预计参数反演基于遗传算法编写。其主界面如图6-1所示。
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image113.jpg) <br>
...
参数反演需导入的原始数据采用EXCEL文件格式，可通过地表移动观测数据整理后的文件格式转换为EXCEL文件格式。图6-2为导入的地表沉陷观测数据，图6-3为求参工作面及遗传算法相关参数的设置。
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image115.png) <br>
图6-2 实际观测值的数据文件准备

  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image117.jpg)  <br>
图6-3 工作面与遗传算法参数设置文件
...
数据导入系统之后，点击【参数反演】，系统自动反演概率积分法预计参数，详细求参结果显示在软件右侧面板纸上，软件反演结果会显示在软件的显示文本框中见图6-6，同时弹出遗传算法收敛速度图，以便查看反演的情况。 
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image119.jpg)   <br>
*图6-5 遗传算法算法收敛图*
...
点击【求参结果】中拟合图，显示实测点与根据反演参数预计点的下沉值的拟合图。
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image123.jpg)    <br>
*图6-7 实测下沉与拟合下沉对比图*
...
系统自动生成Word格式的文本报告，如图6-8。
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image125.jpg)  <br>
*图6-8 Word格式的参数反演报告*
...
|614|	5.34|	5|	770|	185	|倾向长壁|	全部垮落|
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image127.png)  <br>
图6-9工作面与地面观测站井上下对照图
...
（4）点击菜单【求参结果】中【输出参数反演报告】，系统自动生成参数反演的报告。
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image129.png)  <br>
*图6-10 观测站实测数据文件*

  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image131.png)   <br>
*图 6-11参数反演的参数设置文件*
...
|S12|	489|	513|	-24|
  ...
  ![反演](https://github.com/zhuxiaojunahu/MiningSubsidenceDoc/raw/master/DocImage/image133.jpg)   <br>
